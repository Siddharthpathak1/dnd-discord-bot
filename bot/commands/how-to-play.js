  ...
  async execute(interaction) {
    const embed = new EmbedBuilder()
      ...
      .addFields(
        ...
        { name: '4) Prepare Encounter', value: 'DM prepares the encounter. (Map viewer & token placement coming — use `/map-*` commands when available.)', inline: false },
      ...
      .setFooter({ text: 'See /help-dnd for the full command list. Visual map & token UI coming soon.' });
